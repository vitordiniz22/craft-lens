...
abstract class BaseAiProvider implements AiProviderInterface
{
    ...
    protected function buildPrompt(): string
    {
        ...
        $instructions[] = '  • Sexual/adult content (nudity, sexual acts, suggestive content)';
        $instructions[] = '  • Violence (fighting, weapons, blood, injuries, gore, dead bodies)';
        $instructions[] = '  • Hate symbols or imagery';
        $instructions[] = '  • Self-harm imagery';
        $instructions[] = '  • Drug use or paraphernalia';
        $instructions[] = '  Scoring guidance: Mild suggestive content = 0.2-0.4, Partial nudity or visible weapons = 0.4-0.6, Explicit violence/blood/gore or explicit nudity = 0.6-1.0';
        ...
        $instructions[] = '  Adult category should include: nudity, sexual content, suggestive poses, intimate acts';
