...
class ReviewService extends Component
{
     ...
     *
     * @param array{altText?: string, suggestedTitle?: string, longDescription?: string, tags?: array, faceCount?: int, containsPeople?: bool, nsfwScore?: float, hasWatermark?: bool, containsBrandLogo?: bool, focalPointX?: float, focalPointY?: float} $modifications
     * @throws InvalidArgumentException If analysis record not found
     * @throws \RuntimeException If save fails
     */
